...
public class ListLeagueServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * leagueList = new LinkedList<League>(); leagueList.add(new League(2003,
		 * "Spring", "Soccer League (Spring '03)")); leagueList.add(new League(2003,
		 * "Summer", "Summer Soccer Fest 2003")); leagueList.add(new League(2003,
		 * "Fall", "Fall Soccer League (2003)")); leagueList.add(new League(2004,
		 * "Spring", "Soccer League (Spring ‘04)")); leagueList.add(new League(2004,
		 * "Summer", "The Summer of Soccer Love 2004")); leagueList.add(new League(2004,
		 * "Fall", "Fall Soccer League (2004)"));
		 * 
		 * 
		 */
